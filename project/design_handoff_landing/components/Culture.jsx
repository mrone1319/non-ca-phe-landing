...
export default function Culture() {
  return (
    <section className="px-6 md:px-12 py-16 md:py-20 max-w-[1200px] mx-auto">
      ...
      <div className="mt-16">
        ...
        <div className="mt-7 grid grid-cols-3 md:grid-cols-6 gap-3">
          {SOCIAL_PLACEHOLDERS.map((s) => (
            /* TODO: replace with real Instagram / Xiaohongshu check-in photos */
            <img
              key={s.id}
              src={`/assets/social-${s.id}.jpg`}
              alt={s.alt}
