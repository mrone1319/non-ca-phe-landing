  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-md bg-neutral-100 shadow-sm">
      <figure className="relative m-0">
        ...
        <img src={item.image} alt={item.title} className="block w-full aspect-[4/3] object-cover" />
      </figure>
      <div className="p-4">
...
export default function Menu() {
  ...
  return (
    <section id="menu" className="px-6 md:px-12 py-16 md:py-20 max-w-[1200px] mx-auto">
      ...
      <div role="tabpanel" className="grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-7">
