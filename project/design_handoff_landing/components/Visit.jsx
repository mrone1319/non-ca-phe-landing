...
export default function Visit() {
  return (
    <section id="visit" className="px-6 md:px-12 pt-16 md:pt-20 max-w-[1200px] mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-10 rounded-xl bg-sage-100 px-6 py-12 md:px-16">
        <div>
